...
public class MyList
{
    ...
    {
        Node1 temp=start, prev=null,temp1=null;
        do
        {
            prev = temp;
            temp = temp.next;
    ...
    {
        Node1 head2=null, temp=start, temp1=null;
        
        while(temp!=null)
        {
            if(head2 == null)
            {
                temp1 = new Node1(temp.getData());
                head2 = temp1;
                head2.next = null;
            }
            else
    ...
    public static void create(int data)
    {
        ...
        else
        {
            ...
            temp1=new Node1(data);
            temp1.next=null;
            temp.next = temp1;
        }
    }
    
    public static void display(Node1 param)
    {
        Node1 temp = param;
        if (param ==null)
    ...
    {
        Node1 head2=null,prev=start,ptr;
